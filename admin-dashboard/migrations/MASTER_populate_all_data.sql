...
-- Run this in Supabase SQL Editor to populate all pages at once
-- ============================================================
-- This script will add sample data for:
-- 1. Members
-- 2. Trainers  
-- 3. Classes
-- 4. Attendance
...
BEGIN
    ...
    INSERT INTO public.members (
        gym_id, email, phone, full_name, first_name, last_name,
        status, member_plan, trainer_name, join_date
    ) VALUES
    (v_gym_id, 'john.doe@example.com', '+91 98765 43210', 'John Doe', 'John', 'Doe', 'active', '6 Months Plan', 'Sarah M.', CURRENT_DATE - INTERVAL '30 days'),
    (v_gym_id, 'jane.smith@example.com', '+91 98765 43211', 'Jane Smith', 'Jane', 'Smith', 'active', '3 Months Plan', 'Mike T.', CURRENT_DATE - INTERVAL '15 days'),
    (v_gym_id, 'bob.johnson@example.com', '+91 98765 43212', 'Bob Johnson', 'Bob', 'Johnson', 'expiring', '1 Month Plan', 'John D.', CURRENT_DATE - INTERVAL '85 days'),
    (v_gym_id, 'alice.williams@example.com', '+91 98765 43213', 'Alice Williams', 'Alice', 'Williams', 'active', '6 Months Plan', 'Sarah M.', CURRENT_DATE - INTERVAL '60 days'),
    (v_gym_id, 'charlie.brown@example.com', '+91 98765 43214', 'Charlie Brown', 'Charlie', 'Brown', 'expired', '3 Months Plan', 'Mike T.', CURRENT_DATE - INTERVAL '120 days'),
    (v_gym_id, 'diana.prince@example.com', '+91 98765 43215', 'Diana Prince', 'Diana', 'Prince', 'active', '6 Months Plan', 'John D.', CURRENT_DATE - INTERVAL '10 days'),
    (v_gym_id, 'peter.parker@example.com', '+91 98765 43216', 'Peter Parker', 'Peter', 'Parker', 'active', '3 Months Plan', 'Sarah M.', CURRENT_DATE - INTERVAL '45 days'),
    (v_gym_id, 'mary.jane@example.com', '+91 98765 43217', 'Mary Jane', 'Mary', 'Jane', 'expiring', '1 Month Plan', 'Mike T.', CURRENT_DATE - INTERVAL '80 days')
    ...
    INSERT INTO public.users (
        gym_id, role, email, phone, display_name, status, trainer_details
    ) VALUES
    (v_gym_id, 'trainer', 'sarah.m@fitzone.com', '+91 98765 11111', 'Sarah M.', 'active',
    ...
    (v_gym_id, 'trainer', 'mike.t@fitzone.com', '+91 98765 22222', 'Mike T.', 'active',
    ...
    (v_gym_id, 'trainer', 'john.d@fitzone.com', '+91 98765 33333', 'John D.', 'active',
    ...
    (v_gym_id, 'trainer', 'emma.w@fitzone.com', '+91 98765 44444', 'Emma W.', 'active',
    ...
    (v_gym_id, 'trainer', 'david.l@fitzone.com', '+91 98765 55555', 'David L.', 'on_leave',
